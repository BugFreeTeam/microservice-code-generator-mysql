...
public class MysqlDbColumn extends DbTableColumn {
    ...
    private String feildName; // 列名->实体对象字段
    private String feildNameUpper; // 列名->实体对象字段 首字母大写
    private String feildType; // 实体对象字段类型
    ...
    private String jdbcType; //mybatis xml
    private Object columnDefault; // 列缺省值
    private Integer characterOctetLength; // 列最大字节长度，utf-8： // characterMaximumLength* // 3，gbk：characterMaximumLength* 2
    ...
    public String getFeildNameUpper() {
        return feildNameUpper;
    }

    public void setFeildNameUpper(String feildNameUpper) {
        this.feildNameUpper = feildNameUpper;
    }
    ...
    public Object getColumnDefault() {
        return columnDefault == null ? "" : columnDefault;
    }
    ...
    public String toString() {
        ...
        sb.append("; feildName=" + (feildName == null ? "null" : feildName.toString()));
        sb.append("; feildNameUpper=" + (feildNameUpper == null ? "null" : feildNameUpper.toString()));
        sb.append("; feildType=" + (feildType == null ? "null" : feildType.toString()));
