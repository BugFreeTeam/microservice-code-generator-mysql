...
public class MainWindow extends JPanel {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    BeautyEyeLNFHelper.frameBorderStyle = BeautyEyeLNFHelper.FrameBorderStyle.translucencySmallShadow; //translucencySmallShadow
                    BeautyEyeLNFHelper.launchBeautyEyeLNF();
                    UIManager.put("RootPane.setupButtonVisible", false);
                } catch (Exception e) {
                }
                JFrame frame = new JFrame();
                frame.setTitle("基于SpringBoot微服务项目代码构建工具 V" + version);
    ...
    public void showTableDataPanel(CodeModule codeModule){
        ...
        tableDataPanel.viewTableData(codeModule);
