...
| ${column_index+1} | ${column.feildName} | ${column.feildType} | <#if column.feildType == "String">${column.characterMaximumLength}</#if> | <#if column.feildName == "id">NO<#else>YES</#if> | ${column.columnComment} | ${defaultValue} |
</#list>
